...
[![Version](https://img.shields.io/badge/version-0.1.6-blue)](docs/RELEASE-NOTES-0.1.6.md)
...
**v0.1.6 private beta** (2026-09-11). Product features for this line are implemented. Remaining launch work is interactive packaged-app QA, optional Windows Authenticode signing, and macOS (deferred).
...
Release notes: [docs/RELEASE-NOTES-0.1.6.md](docs/RELEASE-NOTES-0.1.6.md) · [0.1.5](docs/RELEASE-NOTES-0.1.5.md) · [0.1.4](docs/RELEASE-NOTES-0.1.4.md) · [0.1.3](docs/RELEASE-NOTES-0.1.3.md) · [0.1.2](docs/RELEASE-NOTES-0.1.2.md) · [0.1.1](docs/RELEASE-NOTES-0.1.1.md) · [0.1.0](docs/RELEASE-NOTES-0.1.0.md)
...
- **Windows 10/11 x64:** `DevDesk-0.1.6-win-x64.exe` from [GitHub Releases](https://github.com/reyanshdagoat9113/DevDesk/releases). Unsigned — SmartScreen may warn.
- **Linux x64:** `DevDesk-0.1.6-linux-x64.deb`.
