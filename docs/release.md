...
Also see: [install.md](./install.md) · [beta-release-checklist.md](./beta-release-checklist.md) · [RELEASE-NOTES-0.1.6.md](./RELEASE-NOTES-0.1.6.md) · [manual-qa.md](./manual-qa.md)
...
Examples: `DevDesk-0.1.6-win-x64.exe`, `DevDesk-0.1.6-linux-x64.deb`.
