...
**Product version:** 0.1.6 (private beta)
...
|----------|---------|------|--------|
| Windows 10/11 | NSIS `DevDesk-0.1.6-win-x64.exe` | x64 | Primary |
| Linux (Debian/Ubuntu family) | `DevDesk-0.1.6-linux-x64.deb` | x64 | Supported |
| macOS | — | — | Not shipped |
